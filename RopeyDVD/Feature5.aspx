<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Feature5.aspx.cs" Inherits="RopeyDVD.LoanMember" %>
    ...
    <div class="main-container">
        <div class="side-bar">
            ...
            <ul class="nav-bars">
                ...
                <li class="active-link"><a class="nav-link" href="Feature5.aspx">Q.5 Latest Loan</a></li>
                ...
                <div class="form-container">
                    <div class="sec">
                        <div class="form-heading-sec">
                            Select CopyNumber and view details of the Member who borrowed it, the date out, due, and returned date.
                        </div>
                        <div class="table-sec">
                            <table class="auto-style2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList CssClass="form-input" ID="CopyNumber_dropdownlist" runat="server" OnSelectedIndexChanged="CopyNumber_dropdownlist_SelectedIndexChanged" AutoPostBack="True" Height="30px" Width="150px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table> 
                        </div>
                        <asp:GridView ID="feature5_details" CssClass="gv" runat="server" OnSelectedIndexChanged="feature5_details_SelectedIndexChanged" Width="1079px" CellPadding="4" ForeColor="#333333" GridLines="None">
